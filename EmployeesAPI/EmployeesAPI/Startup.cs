using AutoMapper;
using EmployeesAPI.Authentication;
...
namespace EmployeesAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CourseContext>(a => 
            a.UseSqlServer(Configuration.GetConnectionString("CourseConnection")));

            services.AddDbContext<ApplicationDbContext>(a =>
          a.UseSqlServer(Configuration.GetConnectionString("ApplicationConnection")));
